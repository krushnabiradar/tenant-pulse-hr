  ...
  const features = [
    {
      ...
      description:
        "Comprehensive employee profiles, attendance tracking, and leave management",
    },
    {
      icon: BarChart3,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-8">
              ...
              employee management to payroll, we've got everything you need to
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Powerful features designed to simplify and automate your HR
              processes
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Card className="hover:border-primary/50 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Manage multiple companies, subscriptions, and system-wide
                  settings
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:border-primary/50 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Oversee employees, attendance, leave requests, and company HR
                  operations
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:border-primary/50 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  View personal dashboard, submit leave requests, and track
                  attendance
                </CardDescription>
              </CardHeader>
              <CardContent>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            Join thousands of companies using TenantPulse to build better
            workplaces
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
